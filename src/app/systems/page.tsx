              ...
              <div className="flex flex-col h-full">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex space-x-2">
                    ...
                    {project.liveUrl && (
                      <Button href={project.liveUrl} variant="ghost" size="sm" target="_blank">
...
{`[Input Stream] ──→ [Kafka] ──→ [Processor]
       ...
       │            │            │
       ▼            ▼            ▼
[Batch Layer] [Real-time] [Anomaly Detect]
       │            │            │
       └────────────┼────────────┘
                    │
            [Output Storage]`}
...
[Editor A]  [Editor B]  [Editor C]
  ...
  └────────────┼────────────┘
    ...
    [Smart Notifications]`}
                    ...
                    {project.id === '5' && (
                      <pre className="whitespace-pre text-center leading-tight">
{`[Monitoring] ──→ [Predictor] ──→ [Alert]
      │              │              │
      ▼              ▼              ▼
 [Metrics]     [ML Analysis]   [Auto-Fix]
      │              │              │
      └──────────────┼──────────────┘
                     │
            [Infrastructure]
